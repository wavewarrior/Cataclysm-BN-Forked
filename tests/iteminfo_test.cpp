...
void test_info_equals(
    const item& i, const iteminfo_query& q, const std::string& reference,
...
void test_info_equals(
    std::string item_name, const iteminfo_query& q, const std::string& reference,
    temperature_flag temperature = temperature_flag::TEMP_NORMAL) {
    item* it = item::spawn_temporary(item_name);
    test_info_equals(*it, q, reference, temperature);
}

void test_info_contains(const item& i, const iteminfo_query& q, const std::string& reference) {
    g->u.clear_mutations();
...
TEST_CASE("item description and physical attributes", "[item][iteminfo][primary]") {
    clear_all_state();
    iteminfo_query q = q_vec(
        {iteminfo_parts::BASE_CATEGORY, iteminfo_parts::BASE_MATERIAL, iteminfo_parts::BASE_VOLUME,
         iteminfo_parts::BASE_WEIGHT, iteminfo_parts::DESCRIPTION});
...
TEST_CASE("item owner, price, and barter value", "[item][iteminfo][price]") {
    clear_all_state();
    iteminfo_query q = q_vec(
        std::vector<iteminfo_parts>({iteminfo_parts::BASE_PRICE, iteminfo_parts::BASE_BARTER}));
...
TEST_CASE("item rigidity", "[item][iteminfo][rigidity]") {
    ...
    SECTION("non-rigid items indicate their flexible volume/encumbrance") {
        test_info_equals("test_waterskin", q,
                         R"(--
...
* This item is <color_c_cyan>not rigid</color>.  Its volume and encumbrance increase with contents.
        ...
        test_info_equals("test_backpack", q,
                         R"(--
...
* This item is <color_c_cyan>not rigid</color>.  Its volume and encumbrance increase with contents.
    ...
    SECTION("rigid items do not indicate they are rigid, since almost all items are") {
        test_info_equals("test_briefcase", q,
                         R"(--
...
TEST_CASE("weapon attack ratings and moves", "[item][iteminfo][weapon]") {
    ...
    iteminfo_query q = q_vec(
        {iteminfo_parts::BASE_DAMAGE, iteminfo_parts::BASE_TOHIT, iteminfo_parts::BASE_MOVES});
...
TEST_CASE("armor coverage and protection values", "[item][iteminfo][armor]") {
    SECTION("shows coverage, encumbrance, and protection for armor with coverage") {
        ...
        test_info_equals(
            longshirt, q_vec({iteminfo_parts::ARMOR_BODYPARTS}),
            "--\n"
            "<color_c_white>Covers</color>:"
            " The <color_c_cyan>torso</color>."
            " The <color_c_cyan>arms</color>. \n"); // NOLINT(cata-text-style)
        test_info_equals(
            longshirt, q_vec({iteminfo_parts::ARMOR_LAYER}),
            "--\n"
        ...
        test_info_equals(
            longshirt, q_vec({iteminfo_parts::ARMOR_COVERAGE, iteminfo_parts::ARMOR_WARMTH}),
        ...
        REQUIRE(
            longshirt.get_encumber_when_containing(
                get_player_character(), longshirt.get_storage(), bodypart_id("torso"))
            == 3);
        REQUIRE(
            longshirt.get_encumber_when_containing(
                get_player_character(), longshirt.get_storage(), bodypart_id("arm_l"))
            == 3);
        REQUIRE(
            longshirt.get_encumber_when_containing(
                get_player_character(), longshirt.get_storage(), bodypart_id("arm_r"))
            == 3);
        REQUIRE(
            longshirt.get_encumber_when_containing(
                get_player_character(), longshirt.get_storage(), bodypart_id("leg_l"))
            == 0);
        REQUIRE(
            longshirt.get_encumber_when_containing(
                get_player_character(), longshirt.get_storage(), bodypart_id("leg_r"))
            == 0);
        REQUIRE(
            longshirt.get_encumber_when_containing(
                get_player_character(), longshirt.get_storage(), bodypart_id("hand_l"))
            == 0);
        REQUIRE(
            longshirt.get_encumber_when_containing(
                get_player_character(), longshirt.get_storage(), bodypart_id("hand_r"))
            == 0);
        REQUIRE(
            longshirt.get_encumber_when_containing(
                get_player_character(), longshirt.get_storage(), bodypart_id("head"))
            == 0);
        REQUIRE(
            longshirt.get_encumber_when_containing(
                get_player_character(), longshirt.get_storage(), bodypart_id("mouth"))
            == 0);
        REQUIRE(
            longshirt.get_encumber_when_containing(
                get_player_character(), longshirt.get_storage(), bodypart_id("foot_l"))
            == 0);
        REQUIRE(
            longshirt.get_encumber_when_containing(
                get_player_character(), longshirt.get_storage(), bodypart_id("foot_r"))
            == 0);


        test_info_equals(
            longshirt, q_vec({iteminfo_parts::ARMOR_ENCUMBRANCE}),
            ""
            R"(--
...
<color_c_white>Encumbrance</color>: <color_c_yellow>3</color> <color_c_cyan>(for all parts)</color>
        ...
        test_info_equals(
            swat_armor, q_vec({iteminfo_parts::ARMOR_BODYPARTS}),
            "--\n"
            "<color_c_white>Covers</color>:"
            " The <color_c_cyan>torso</color>."
            " The <color_c_cyan>arms</color>."
        ...
        test_info_equals(
            swat_armor, q_vec({iteminfo_parts::ARMOR_LAYER}),
            "--\n"
            "Layer: <color_c_light_blue>Normal</color>. \n"); // NOLINT(cata-text-style)
        ...
        test_info_equals(
            swat_armor, q_vec({iteminfo_parts::ARMOR_COVERAGE, iteminfo_parts::ARMOR_WARMTH}),
        ...
        REQUIRE(
            swat_armor.get_encumber_when_containing(
                get_player_character(), swat_armor.get_storage(), bodypart_id("torso"))
            == 25);
        REQUIRE(
            swat_armor.get_encumber_when_containing(
                get_player_character(), swat_armor.get_storage(), bodypart_id("arm_l"))
            == 25);
        REQUIRE(
            swat_armor.get_encumber_when_containing(
                get_player_character(), swat_armor.get_storage(), bodypart_id("arm_r"))
            == 25);
        REQUIRE(
            swat_armor.get_encumber_when_containing(
                get_player_character(), swat_armor.get_storage(), bodypart_id("leg_l"))
            == 25);
        REQUIRE(
            swat_armor.get_encumber_when_containing(
                get_player_character(), swat_armor.get_storage(), bodypart_id("leg_r"))
            == 25);
        REQUIRE(
            swat_armor.get_encumber_when_containing(
                get_player_character(), swat_armor.get_storage(), bodypart_id("hand_l"))
            == 0);
        REQUIRE(
            swat_armor.get_encumber_when_containing(
                get_player_character(), swat_armor.get_storage(), bodypart_id("hand_r"))
            == 0);
        REQUIRE(
            swat_armor.get_encumber_when_containing(
                get_player_character(), swat_armor.get_storage(), bodypart_id("head"))
            == 0);
        REQUIRE(
            swat_armor.get_encumber_when_containing(
                get_player_character(), swat_armor.get_storage(), bodypart_id("mouth"))
            == 0);
        REQUIRE(
            swat_armor.get_encumber_when_containing(
                get_player_character(), swat_armor.get_storage(), bodypart_id("foot_l"))
            == 0);
        REQUIRE(
            swat_armor.get_encumber_when_containing(
                get_player_character(), swat_armor.get_storage(), bodypart_id("foot_r"))
            == 0);
...
<color_c_white>Encumbrance</color>: <color_c_yellow>12-25</color> (When Full) <color_c_cyan>(for all parts)</color>
        ...
        test_info_equals(
            faux_fur_pants, q_vec({iteminfo_parts::ARMOR_BODYPARTS}),
            "--\n"
            "<color_c_white>Covers</color>:"
            " The <color_c_cyan>legs</color>. \n"); // NOLINT(cata-text-style)

        test_info_equals(
            faux_fur_pants, q_vec({iteminfo_parts::ARMOR_LAYER}),
            "--\n"
            "Layer: <color_c_light_blue>Normal</color>. \n"); // NOLINT(cata-text-style)
        ...
        test_info_equals(
            faux_fur_pants, q_vec({iteminfo_parts::ARMOR_COVERAGE, iteminfo_parts::ARMOR_WARMTH}),
        ...
        REQUIRE(
            faux_fur_pants.get_encumber_when_containing(
                get_player_character(), faux_fur_pants.get_storage(), bodypart_id("torso"))
            == 0);
        REQUIRE(
            faux_fur_pants.get_encumber_when_containing(
                get_player_character(), faux_fur_pants.get_storage(), bodypart_id("arm_l"))
            == 0);
        REQUIRE(
            faux_fur_pants.get_encumber_when_containing(
                get_player_character(), faux_fur_pants.get_storage(), bodypart_id("arm_r"))
            == 0);
        REQUIRE(
            faux_fur_pants.get_encumber_when_containing(
                get_player_character(), faux_fur_pants.get_storage(), bodypart_id("leg_l"))
            == 20);
        REQUIRE(
            faux_fur_pants.get_encumber_when_containing(
                get_player_character(), faux_fur_pants.get_storage(), bodypart_id("leg_r"))
            == 20);
        REQUIRE(
            faux_fur_pants.get_encumber_when_containing(
                get_player_character(), faux_fur_pants.get_storage(), bodypart_id("hand_l"))
            == 0);
        REQUIRE(
            faux_fur_pants.get_encumber_when_containing(
                get_player_character(), faux_fur_pants.get_storage(), bodypart_id("hand_r"))
            == 0);
        REQUIRE(
            faux_fur_pants.get_encumber_when_containing(
                get_player_character(), faux_fur_pants.get_storage(), bodypart_id("head"))
            == 0);
        REQUIRE(
            faux_fur_pants.get_encumber_when_containing(
                get_player_character(), faux_fur_pants.get_storage(), bodypart_id("mouth"))
            == 0);
        REQUIRE(
            faux_fur_pants.get_encumber_when_containing(
                get_player_character(), faux_fur_pants.get_storage(), bodypart_id("foot_l"))
            == 0);
        REQUIRE(
            faux_fur_pants.get_encumber_when_containing(
                get_player_character(), faux_fur_pants.get_storage(), bodypart_id("foot_r"))
            == 0);
        ...
        test_info_equals(
            faux_fur_suit, q_vec({iteminfo_parts::ARMOR_BODYPARTS}),
            "--\n"
            "<color_c_white>Covers</color>:"
        ...
        test_info_equals(
            faux_fur_suit, q_vec({iteminfo_parts::ARMOR_LAYER}),
            "--\n"
            "Layer: <color_c_light_blue>Normal</color>. \n"); // NOLINT(cata-text-style)
        ...
        test_info_equals(
            faux_fur_suit, q_vec({iteminfo_parts::ARMOR_COVERAGE, iteminfo_parts::ARMOR_WARMTH}),
            "--\nWarmth: <color_c_yellow>5</color>\n");
        ...
        REQUIRE(
            faux_fur_suit.get_encumber_when_containing(
                get_player_character(), faux_fur_suit.get_storage(), bodypart_id("torso"))
            == 25);
        REQUIRE(
            faux_fur_suit.get_encumber_when_containing(
                get_player_character(), faux_fur_suit.get_storage(), bodypart_id("arm_l"))
            == 5);
        REQUIRE(
            faux_fur_suit.get_encumber_when_containing(
                get_player_character(), faux_fur_suit.get_storage(), bodypart_id("arm_r"))
            == 25);
        REQUIRE(
            faux_fur_suit.get_encumber_when_containing(
                get_player_character(), faux_fur_suit.get_storage(), bodypart_id("leg_l"))
            == 5);
        REQUIRE(
            faux_fur_suit.get_encumber_when_containing(
                get_player_character(), faux_fur_suit.get_storage(), bodypart_id("leg_r"))
            == 25);
        REQUIRE(
            faux_fur_suit.get_encumber_when_containing(
                get_player_character(), faux_fur_suit.get_storage(), bodypart_id("hand_l"))
            == 0);
        REQUIRE(
            faux_fur_suit.get_encumber_when_containing(
                get_player_character(), faux_fur_suit.get_storage(), bodypart_id("hand_r"))
            == 0);
        REQUIRE(
            faux_fur_suit.get_encumber_when_containing(
                get_player_character(), faux_fur_suit.get_storage(), bodypart_id("head"))
            == 5);
        REQUIRE(
            faux_fur_suit.get_encumber_when_containing(
                get_player_character(), faux_fur_suit.get_storage(), bodypart_id("mouth"))
            == 0);
        REQUIRE(
            faux_fur_suit.get_encumber_when_containing(
                get_player_character(), faux_fur_suit.get_storage(), bodypart_id("foot_l"))
            == 0);
        REQUIRE(
            faux_fur_suit.get_encumber_when_containing(
                get_player_character(), faux_fur_suit.get_storage(), bodypart_id("foot_r"))
            == 0);
...
<color_c_white>Encumbrance</color>: <color_c_red>(poor fit)</color>
  ...
  R. Arm, R. Leg, Torso: <color_c_yellow>10-25</color> (When Full)
    ...
    iteminfo_query q = q_vec(
        {iteminfo_parts::ARMOR_BODYPARTS, iteminfo_parts::ARMOR_LAYER,
...
TEST_CASE("ranged weapon attributes", "[item][iteminfo][weapon][ranged][gun]") {
    ...
    SECTION("weapon damage including floating-point multiplier") {
        iteminfo_query q = q_vec(
            {iteminfo_parts::GUN_DAMAGE, iteminfo_parts::GUN_DAMAGE_LOADEDAMMO,
...
TEST_CASE("ammunition", "[item][iteminfo][ammo]") {
    clear_all_state();
    iteminfo_query q = q_vec(
        {iteminfo_parts::AMMO_REMAINING_OR_TYPES, iteminfo_parts::AMMO_DAMAGE_VALUE,
...
TEST_CASE("nutrients in food", "[item][iteminfo][food]") {
    clear_all_state();
    iteminfo_query q = q_vec(
        {iteminfo_parts::FOOD_NUTRITION, iteminfo_parts::FOOD_VITAMINS,
...
TEST_CASE("food freshness and lifetime", "[item][iteminfo][food]") {
    ...
    SECTION("liquid food is stored in a container in a fridge") {
        detached_ptr<item> food_item =
            item::in_container(itype_id("can_medium_unsealed"), item::spawn(itype_id("milk")));
        test_info_equals(
            *food_item, q,
            "--\n"
            "* This food is <color_c_yellow>perishable</color>, and at room temperature"
...
TEST_CASE("repairable and with what tools", "[item][iteminfo][repair]") {
    ...
    test_info_contains(
        *item::spawn("test_socks"), q, "* This item can be <color_c_green>reinforced</color>.\n");
}
