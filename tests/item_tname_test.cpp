    ...
    GIVEN("some clothing") {
        ...
        WHEN("it is undamaged") {
            ...
            THEN("it appears undamaged") {
                CHECK(shirt.tname()
                      == "<color_c_light_green>||\u00A0</color>long-sleeved shirt (poor fit)");
            }
        }
        ...
        WHEN("is is one-quarter damaged") {
            ...
            THEN("it appears slightly damaged") {
                CHECK(shirt.tname()
                      == "<color_c_yellow>|\\\u00A0</color>long-sleeved shirt (poor fit)");
            }
        }
        ...
        WHEN("it is half damaged") {
            ...
            THEN("it appears moderately damaged") {
                CHECK(shirt.tname()
                      == "<color_c_magenta>|.\u00A0</color>long-sleeved shirt (poor fit)");
            }
        }
        ...
        WHEN("it is three-quarters damaged") {
            ...
            THEN("it appears heavily damaged") {
                CHECK(shirt.tname()
                      == "<color_c_light_red>\\.\u00A0</color>long-sleeved shirt (poor fit)");
            }
        }
        ...
        WHEN("it is totally damaged") {
            ...
            THEN("it appears almost destroyed") {
                CHECK(shirt.tname()
                      == "<color_c_dark_gray>XX\u00A0</color>long-sleeved shirt (poor fit)");
            }
        }
    }
...
TEST_CASE("weapon fouling", "[item][tname][fouling][dirt]") {
    ...
    GIVEN("a gun with potential fouling") {
        ...
        // Ensure the player and gun are normal size to prevent "too big" or "too small" suffix in
        // tname
        g->u.clear_mutations();
