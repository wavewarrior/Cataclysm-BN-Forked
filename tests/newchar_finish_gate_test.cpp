...
TEST_CASE("nc_finish_a_valid_named_character_with_no_spare_is_ready", "[newchar][finish_gate]") {
    const nc_finish_gate::inputs in =
        {.valid = true,
         .stat_left = 0,
         .trait_left = 0,
         .skill_left = 0,
...
TEST_CASE(
    "nc_finish_an_invalid_pool_blames_skills_then_traits_then_stats", "[newchar][finish_gate]") {
...
TEST_CASE(
    "nc_finish_an_overspend_outranks_spare_points_and_a_missing_name", "[newchar][finish_gate]") {
...
TEST_CASE(
    "nc_finish_unspent_points_in_a_freeform_pool_are_not_a_question", "[newchar][finish_gate]") {
