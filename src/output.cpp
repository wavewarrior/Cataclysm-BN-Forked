 ...
 * @param bDoNotScrollToEnd True if the last (iContentHeight-1) lines cannot be a start position or
 * be selected If false, iCurrentLine can be from 0 to iNumLines - 1. If true, iCurrentLine can be
 * at most iNumLines - iContentHeight.
 **/
void draw_scrollbar(
...
nc_color msgtype_to_color( const game_message_type type, const bool bOldMsg )
{
    static const std::map<game_message_type, std::pair<nc_color, nc_color>> colors{
        ...
        {m_info, {c_light_blue, c_blue}},   {m_neutral, {c_white, c_light_gray}},
