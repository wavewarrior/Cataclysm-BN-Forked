...
MAKE_CLASS_NULL_ID( enchantment, "null" )
MAKE_CLASS_NULL_ID( enchantment_value, "null" )
MAKE_CLASS_NULL_ID( enchantment_flag, "null" )
...
MAKE_CLASS_NULL_ID( MapgenColorPalette, "null" )
