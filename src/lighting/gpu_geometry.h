...
class gpu_geometry
{
    public:
        ...
        void rect( sprite_batcher &dst, float x, float y, float w, float h,
                   const float rgba[4] ) const;
        void horizontal_line( sprite_batcher &dst, float x, float y, float x2,
                              float thickness, const float rgba[4] ) const;
        void vertical_line( sprite_batcher &dst, float x, float y, float y2,
                            float thickness, const float rgba[4] ) const;
