...
std::string io::enum_to_string<action_id>( action_id data )
{
    switch( data ) {
            ...
            PAIR( ACTION_MEND )
            PAIR( ACTION_THROW )
            PAIR( ACTION_THROW_QUICKSLOT )
            PAIR( ACTION_FIRE )
            PAIR( ACTION_AIM_HOLD )
            ...
            PAIR( ACTION_TOGGLE_SOMA_DETAIL )
            PAIR( ACTION_DISPLAY_SOUND )
            PAIR( ACTION_TOGGLE_FPS )
            PAIR( ACTION_CO_OP_CHAT )
            PAIR( ACTION_CO_OP_TAP_SHOULDER )
            PAIR( ACTION_CO_OP_EMOTE )
            PAIR( ACTION_CO_OP_STABILIZE )
            PAIR( ACTION_CO_OP_PASS_ITEM )
            PAIR( ACTION_CO_OP_MARK_OVERMAP )
        case NUM_ACTIONS:
            break;
    }
...
std::string action_ident( action_id act )
{
    switch( act ) {
        ...
        case ACTION_CO_OP_EMOTE:
            return "CO_OP_EMOTE";
        case ACTION_CO_OP_STABILIZE:
            return "CO_OP_STABILIZE";
        case ACTION_CO_OP_PASS_ITEM:
