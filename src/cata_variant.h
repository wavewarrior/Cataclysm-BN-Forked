...
static_assert( static_cast<int>( cata_variant_type::num_types ) == 41,
...
template<>
struct convert<cata_variant_type::enchantment_value_id> :
    convert_string_id<enchantment_value_id> {};

template<>
struct convert<cata_variant_type::enchantment_flag_id> :
    convert_string_id<enchantment_flag_id> {};
...
template<>
struct convert<cata_variant_type::mpalette_id> : convert_string_id<mpalette_id> {};
...
template<>
struct convert<cata_variant_type::vpalette_id> : convert_string_id<vpalette_id> {};
