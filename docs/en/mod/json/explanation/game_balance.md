...
Gun durability is an integer usually between 1-9, but it can be higher. It is used for the following purposes:

- chance of damage on failure to install gunmods
- underwater misfire chance
- malfunction chance

It does NOT affect:

- chance to gain fouling
- chance of fouling to cause a malfunction or damage the gun
...
Normal shots increase fouling by 1, and cannot raise fouling above 7150. Blackpowder rounds will increase fouling **much** faster, and can increase fouling to 10000.
Fouling can cause jams, the chance of which is **not** affected by gun durability.
The formula for fouling-caused jams is exponential: 0.1% of the shots will jam at 1000 foul, 0.8% at 2000 foul, 2.7% at 3000, then 6.4%, 12.5%, 21.6%, and 34% at 7000 foul. This is _in addition_ to the malfunction chance described above.
Additionally, at high values (5000+), jams can damage the gun (3% chance per shot at 6000, 6% at 7000).

### Blackpowder_tolerance

This is a value separate from gun durability. It indicates, as a percentage*, how resistant a gun is to fouling generated by blackpowder.

8 - Default if unspecified, but not common. It takes 55 blackpowder shots to fully foul a gun. Badly made guns.

24 - It takes 66 blackpowder shots to fully foul a gun. Pistols and SMGs.
