...
you will see the list of hook ids as well as function signatures that they expect.

See also: [`hooks.md`](../hooks.md) (priority ordering, new registration format, chaining).

You can register new hooks using `game.add_hook`:
